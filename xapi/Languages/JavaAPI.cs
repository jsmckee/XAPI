...
namespace Korelight.XAPI
{
	...
	/// </summary>
	public class JavaApi<ControllerType> : XCore<ControllerType>
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		...
		/// <summary>
		/// Get a runtime computed Java API for a given Web API service Type.
		/// </summary>
		...
		public override Stream GetAPI(String controller)
		{
			...
			api.Append("// Java API Generated by the Korelight XAPI Service.");
